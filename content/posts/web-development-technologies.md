...
0. [JavaScript (es5, es6, etc.)](https://www.javascript.com/)
1. [Node.js](https://nodejs.org/en/)
2. [TypeScript](https://www.typescriptlang.org/)
3. [CSS: Cascading Style Sheets](https://developer.mozilla.org/en-US/docs/Web/CSS)
...
8. [XML](https://www.xml.com/)
9. [Http](https://developer.mozilla.org/en-US/docs/Web/HTTP)
10. [WebSockets](https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API)
11. [GNU Bash](https://www.gnu.org/software/bash/)
12. [SQL](https://en.wikipedia.org/wiki/SQL)
...
0. [Webpack](https://webpack.js.org/)
...
0. [Postgres](https://www.postgresql.org/)
...
0. [AWS: Amazon Web Services](https://aws.amazon.com/)
...
0. [Travis CI](https://www.travis-ci.com/)
...
0. [Postman](https://www.postman.com/)
1. [SSH: Secure Shell](https://www.ssh.com/ssh/)
2. [ngrok](https://ngrok.com/)
3. [curl](https://curl.se/)
4. [scrcpy](https://github.com/Genymobile/scrcpy#readme)
